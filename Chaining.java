...
public class Chaining {
    ...
    public int chain (int key) {
        ...
        int h = ((this.A*key)%power2(this.w))/power2(this.w-this.r);
    ...
    public int insertKey(int key){
        int slot = this.chain(key);
        ArrayList<Integer> slotLinkedList = this.Table.get(slot);
        int collision = slotLinkedList.size();
        slotLinkedList.add(key);
        return collision;
    }
